...
/*
Plugin Name: 日志自动截断
Plugin URI: http://blog.manbu.biz
Description: 自动截断日志文字的插件，使用此插件后，撰写日志时无需再加入more标签进行文字截断操作。采用UTF-8模式截取，中文无乱码。
Version: 0.7
Author: Jens T&ouml;rnell ; Mark Lin 中文化修改
Author URI: http://blog.manbu.biz

修改日期: 2008-07-17
修改说明: 取消了Letter分割方式，因为中文中不存在Letter和Word的差别，文件保存编码为UTF-8. 取消用utf8_encode函数对“阅读全文”的文字进行编码，否则这几个文字显示乱码。此插件在Wordpress 2.6中文版中测试通过，其他版本是否适用暂时未知。
