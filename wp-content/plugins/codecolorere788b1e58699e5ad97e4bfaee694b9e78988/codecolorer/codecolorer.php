...
class CodeColorer {
  ...
  function init() {
    ...
    $this->pluginLocation = '/wp-content/' . ixiezi::install_dir(__FILE__) . '/codecolorer/';
  ...
  function addPluginOptionsPage() {
    if (function_exists('add_options_page')) {
      add_options_page('代码高亮', '代码高亮', 9, 'codecolorer/codecolorer-options.php', "display_options_form");
    }
  }
